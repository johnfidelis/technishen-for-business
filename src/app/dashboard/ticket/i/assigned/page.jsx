  ...
  return (
    ...
    >
      <Box sx={{ mb: '2em', textAlign: 'left' }}>
        ...
        >
          Assigned Tickets {`(${number})`}
          <Tooltip
            title="This page displays tickets that have already been assigned to an employee. You can view, monitor progress, or reassign them if needed.
...
"
        ...
        {[
          {
            ...
            value: ticketStat?.assigned_tickets?.today || 0,
            icon: <InsertDriveFileIcon sx={{ color: 'white' }} />,
          },
          {
            title: 'Average Monthly Tickets',
            value: ticketStat?.assigned_tickets?.monthly_average || 0,
            icon: <ListAltIcon sx={{ color: 'white' }} />,
          },
          {
            title: 'Total Tickets',
            value: ticketStat?.assigned_tickets?.total_this_month || 0,
      ...
      <TicketTable filterType="assigned" setNumber={setNumber} />
    </Box>
  )
}
